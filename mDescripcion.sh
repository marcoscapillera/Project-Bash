...
#-----------------INGRESO DE DATO----------------------------------------------
echo "Ingrese la id que corresponde a la descripcion a modificar"
...
nuevo="${id}$SEP${cedula}$SEP${servicio}$SEP${datonuevo}$SEP${importe}$SEP${fecha}$SEP${vendedor}"


sed  -r -i "s/${viejo}/${nuevo}/g"  "ARCHIVO_LISTA_DE_SERVICIOS.txt"


echo "La descripcion fue modificado con exito"
